<template>
  <div>
    ...
    <div>
      <img class="map-front" src="../../assets/muscles-map/front-model.jpg" width="288" height="618"
           usemap="#front-model"/>
    ...
    <div>
      <img class="map-back" src="../../assets/muscles-map/front-model.jpg" width="288" height="618"
           usemap="#back-model"/>
  ...
  export default {
    ...
    methods: {
      ...
      highlightSelectedAreas() {
        ...
        this.selectedAreas = newAreasToSet;
        this.mapFront.setSelectedAreas(this.selectedAreas);
        this.mapBack.setSelectedAreas(this.selectedAreas);
      },
...
<style>
  ...
  .selected[data-group-id="upperTrapezius"] {
